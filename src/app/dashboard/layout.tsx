                ...
                <div className="flex h-full max-h-screen flex-col gap-2">
                    ...
                    <div className="flex h-[60px] items-center border-t px-6">
                        <form className="flex items-center gap-2 ml-auto">
                            ...
                            <Input
                                className="w-0 placeholder-gray-500 appearance-none bg-transparent border-none outline-none w-4 flex-1 dark:placeholder-gray-400"
                                placeholder="Search..."
                                type="search"
                            />
                        </form>
                                ...
                                <div className="grid items-center gap-4 md:grid-cols-2 xl:grid-cols-3">
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 w-full grid ml-4 text-left">
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">View all products in the store</p>
                                        </div>
                                    </Link>
                                    <Link
                                        className="flex items-center rounded-lg border border-gray-200 border-gray-200 bg-white shadow-sm p-4 w-full transition-transform hover:scale-105 hover:shadow-md dark:border-gray-800 dark:border-gray-800 dark:bg-gray-950 dark:hover:shadow-md"
